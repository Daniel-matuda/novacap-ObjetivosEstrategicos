...
@section('content')
    ...
    @if (session()->has('updated_success'))
        <x-alert key="success" :message="session()->get('updated_success')"></x-alert>
        {{-- <p class="alert alert-success">{{ session()->get('success') }}</p> --}}
    @elseif (session()->has('error'))
        <x-alert key="danger" :message="session()->get('updated_error')"></x-alert>
        {{-- <p class="alert alert-error">{{ session()->get('error', 'Erro ao cadastrar') }}</p> --}}
    @endif
    ...
    @if (session()->has('password_success'))
        <x-alert key="success" :message="session()->get('password_success')"></x-alert>
        {{-- <p class="alert alert-success">{{ session()->get('success') }}</p> --}}
    @elseif (session()->has('error'))
        <x-alert key="danger" :message="session()->get('password_error')"></x-alert>
        {{-- <p class="alert alert-error">{{ session()->get('error', 'Erro ao cadastrar') }}</p> --}}
    @endif
